...
> <div className='bg-white rounded-lg p-6 w-full max-w-md mx-4 shadow-xl border border-gray-200'> <div className='flex justify-between items-center mb-6'> <h2 className='text-2xl font-bold text-gray-800'>
{t('newAppointment')} </h2> <button
         onClick={onClose}
