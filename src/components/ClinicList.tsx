...
<div className="text-center py-8">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">{t('noClinics')}</h3>
          <p className="mt-1 text-sm text-gray-500">{t('noClinicsDesc')}</p>
        </div>
      ) : (
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    {clinic.address.country}                  </p>
                  <p className="text-sm text-gray-500 mt-1">{clinic.address.country}</p>
                  {clinic.location && (
                    <p className="text-xs text-gray-400 mt-1">
                      {t('location')}: {clinic.location.coordinates[1].toFixed(4)},{' '}
